# Generated by Powerlevel10k configuration wizard on 2021-01-22 at 13:29 KST.
...
# sharp heads, blurred tails, 2 lines, dotted, left frame, sparse, fluent,
...
() {
  ...
  ######################################[ ram: free RAM ]#######################################
  local usage_color=87
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=$usage_color
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=$usage_color

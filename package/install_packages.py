...
if __name__ == "__main__":
	...
	def add_flag(long: str, short: str, helpstr: str):
		parser.add_argument(long, short, help=helpstr, action="store_true", default=False)

	parser.add_argument("--dist", "-d", help="select distribution", choices=["debian", "redhat", "darwin"], required=True)
